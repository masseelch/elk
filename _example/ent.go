...
//	Aggregate(_example.As(_example.Sum(field1), "sum_field1"), (_example.As(_example.Sum(field2), "sum_field2")).
//	Scan(ctx, &v)
//
...
func (e *NotFoundError) Error() string {
	return "_example: " + e.label + " not found"
}
...
func (e *NotSingularError) Error() string {
	return "_example: " + e.label + " not singular"
}
...
func (e *NotLoadedError) Error() string {
	return "_example: " + e.edge + " edge was not loaded"
}
...
func (e ConstraintError) Error() string {
	return "_example: constraint failed: " + e.msg
}

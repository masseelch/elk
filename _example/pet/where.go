...
func Color(v schema.Color) predicate.Pet {
	vc := uint32(v)
	return predicate.Pet(func(s *sql.Selector) {
...
func ColorNEQ(v schema.Color) predicate.Pet {
	vc := uint32(v)
	return predicate.Pet(func(s *sql.Selector) {
...
func ColorIn(vs ...schema.Color) predicate.Pet {
	v := make([]interface{}, len(vs))
	for i := range v {
		v[i] = uint32(vs[i])
	}
...
func ColorNotIn(vs ...schema.Color) predicate.Pet {
	v := make([]interface{}, len(vs))
	for i := range v {
		v[i] = uint32(vs[i])
	}
...
func ColorGT(v schema.Color) predicate.Pet {
	vc := uint32(v)
	return predicate.Pet(func(s *sql.Selector) {
...
func ColorGTE(v schema.Color) predicate.Pet {
	vc := uint32(v)
	return predicate.Pet(func(s *sql.Selector) {
...
func ColorLT(v schema.Color) predicate.Pet {
	vc := uint32(v)
	return predicate.Pet(func(s *sql.Selector) {
...
func ColorLTE(v schema.Color) predicate.Pet {
	vc := uint32(v)
	return predicate.Pet(func(s *sql.Selector) {

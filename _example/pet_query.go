...
func (pq *PetQuery) sqlAll(ctx context.Context) ([]*Pet, error) {
	...
	if query := pq.withOwner; query != nil {
		...
		for i := range nodes {
			if fk := nodes[i].owner_pets; fk != nil {
				ids = append(ids, *fk)
...
func (pgb *PetGroupBy) Strings(ctx context.Context) ([]string, error) {
	if len(pgb.fields) > 1 {
		return nil, errors.New("_example: PetGroupBy.Strings is not achievable when grouping more than 1 field")
	}
	var v []string
	if err := pgb.Scan(ctx, &v); err != nil {
		return nil, err
...
func (pgb *PetGroupBy) String(ctx context.Context) (_ string, err error) {
	...
	case 0:
		err = &NotFoundError{pet.Label}
	default:
		err = fmt.Errorf("_example: PetGroupBy.Strings returned %d results when one was expected", len(v))
	}
	return
}
...
func (pgb *PetGroupBy) Ints(ctx context.Context) ([]int, error) {
	if len(pgb.fields) > 1 {
		return nil, errors.New("_example: PetGroupBy.Ints is not achievable when grouping more than 1 field")
	}
	var v []int
	if err := pgb.Scan(ctx, &v); err != nil {
		return nil, err
...
func (pgb *PetGroupBy) Int(ctx context.Context) (_ int, err error) {
	...
	case 0:
		err = &NotFoundError{pet.Label}
	default:
		err = fmt.Errorf("_example: PetGroupBy.Ints returned %d results when one was expected", len(v))
	}
	return
}
...
func (pgb *PetGroupBy) Float64s(ctx context.Context) ([]float64, error) {
	if len(pgb.fields) > 1 {
		return nil, errors.New("_example: PetGroupBy.Float64s is not achievable when grouping more than 1 field")
	}
	var v []float64
	if err := pgb.Scan(ctx, &v); err != nil {
		return nil, err
...
func (pgb *PetGroupBy) Float64(ctx context.Context) (_ float64, err error) {
	...
	case 0:
		err = &NotFoundError{pet.Label}
	default:
		err = fmt.Errorf("_example: PetGroupBy.Float64s returned %d results when one was expected", len(v))
	}
	return
}
...
func (pgb *PetGroupBy) Bools(ctx context.Context) ([]bool, error) {
	if len(pgb.fields) > 1 {
		return nil, errors.New("_example: PetGroupBy.Bools is not achievable when grouping more than 1 field")
	}
	var v []bool
	if err := pgb.Scan(ctx, &v); err != nil {
		return nil, err
...
func (pgb *PetGroupBy) Bool(ctx context.Context) (_ bool, err error) {
	...
	case 0:
		err = &NotFoundError{pet.Label}
	default:
		err = fmt.Errorf("_example: PetGroupBy.Bools returned %d results when one was expected", len(v))
	}
	return
}
...
func (ps *PetSelect) Strings(ctx context.Context) ([]string, error) {
	if len(ps.fields) > 1 {
		return nil, errors.New("_example: PetSelect.Strings is not achievable when selecting more than 1 field")
	}
	var v []string
	if err := ps.Scan(ctx, &v); err != nil {
		return nil, err
...
func (ps *PetSelect) String(ctx context.Context) (_ string, err error) {
	...
	case 0:
		err = &NotFoundError{pet.Label}
	default:
		err = fmt.Errorf("_example: PetSelect.Strings returned %d results when one was expected", len(v))
	}
	return
}
...
func (ps *PetSelect) Ints(ctx context.Context) ([]int, error) {
	if len(ps.fields) > 1 {
		return nil, errors.New("_example: PetSelect.Ints is not achievable when selecting more than 1 field")
	}
	var v []int
	if err := ps.Scan(ctx, &v); err != nil {
		return nil, err
...
func (ps *PetSelect) Int(ctx context.Context) (_ int, err error) {
	...
	case 0:
		err = &NotFoundError{pet.Label}
	default:
		err = fmt.Errorf("_example: PetSelect.Ints returned %d results when one was expected", len(v))
	}
	return
}
...
func (ps *PetSelect) Float64s(ctx context.Context) ([]float64, error) {
	if len(ps.fields) > 1 {
		return nil, errors.New("_example: PetSelect.Float64s is not achievable when selecting more than 1 field")
	}
	var v []float64
	if err := ps.Scan(ctx, &v); err != nil {
		return nil, err
...
func (ps *PetSelect) Float64(ctx context.Context) (_ float64, err error) {
	...
	case 0:
		err = &NotFoundError{pet.Label}
	default:
		err = fmt.Errorf("_example: PetSelect.Float64s returned %d results when one was expected", len(v))
	}
	return
}
...
func (ps *PetSelect) Bools(ctx context.Context) ([]bool, error) {
	if len(ps.fields) > 1 {
		return nil, errors.New("_example: PetSelect.Bools is not achievable when selecting more than 1 field")
	}
	var v []bool
	if err := ps.Scan(ctx, &v); err != nil {
		return nil, err
...
func (ps *PetSelect) Bool(ctx context.Context) (_ bool, err error) {
	...
	case 0:
		err = &NotFoundError{pet.Label}
	default:
		err = fmt.Errorf("_example: PetSelect.Bools returned %d results when one was expected", len(v))
	}
	return
}

...
func (pu *PetUpdate) SetColor(s schema.Color) *PetUpdate {
	pu.mutation.ResetColor()
	pu.mutation.SetColor(s)
	return pu
}

// AddColor adds s to color.
func (pu *PetUpdate) AddColor(s schema.Color) *PetUpdate {
	pu.mutation.AddColor(s)
	return pu
}
...
// SetNillableOwnerID sets the owner edge to Owner by id if the given value is not nil.
...
// SetOwner sets the owner edge to Owner.
...
// ClearOwner clears the "owner" edge to type Owner.
...
func (pu *PetUpdate) sqlSave(ctx context.Context) (n int, err error) {
	...
	if value, ok := pu.mutation.Color(); ok {
		_spec.Fields.Set = append(_spec.Fields.Set, &sqlgraph.FieldSpec{
			...
			Value:  value,
			Column: pet.FieldColor,
		})
	}
	if value, ok := pu.mutation.AddedColor(); ok {
		_spec.Fields.Add = append(_spec.Fields.Add, &sqlgraph.FieldSpec{
			Type:   field.TypeUint32,
			Value:  value,
			Column: pet.FieldColor,
...
// SetColor sets the color field.
func (puo *PetUpdateOne) SetColor(s schema.Color) *PetUpdateOne {
	puo.mutation.ResetColor()
	puo.mutation.SetColor(s)
	return puo
}

// AddColor adds s to color.
func (puo *PetUpdateOne) AddColor(s schema.Color) *PetUpdateOne {
	puo.mutation.AddColor(s)
	return puo
}
...
func (puo *PetUpdateOne) sqlSave(ctx context.Context) (_node *Pet, err error) {
	...
	if value, ok := puo.mutation.AddedColor(); ok {
		_spec.Fields.Add = append(_spec.Fields.Add, &sqlgraph.FieldSpec{
			Type:   field.TypeUint32,
			Value:  value,
			Column: pet.FieldColor,

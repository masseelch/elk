...
The OpenAPI Specification generator is now part of (ent/contrib). The OAS generator API has changed as has the generated
spec. However, this package will follow the changes done in the OAS generator and eventually behave as described by the
spec.

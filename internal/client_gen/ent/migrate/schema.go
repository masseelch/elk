...
var (
	...
	// CollarsColumns holds the columns for the "collars" table.
	CollarsColumns = []*schema.Column{
		{Name: "id", Type: field.TypeInt, Increment: true},
		{Name: "color", Type: field.TypeEnum, Enums: []string{"green", "red", "blue"}},
		{Name: "pet_collar", Type: field.TypeString, Unique: true, Nullable: true},
	}
	// CollarsTable holds the schema information for the "collars" table.
	CollarsTable = &schema.Table{
		Name:       "collars",
		Columns:    CollarsColumns,
		PrimaryKey: []*schema.Column{CollarsColumns[0]},
		ForeignKeys: []*schema.ForeignKey{
			{
				Symbol:     "collars_pets_collar",
				Columns:    []*schema.Column{CollarsColumns[2]},
	...
	PetsColumns = []*schema.Column{
		...
		{Name: "name", Type: field.TypeString},
		{Name: "age", Type: field.TypeInt},
		{Name: "owner_pets", Type: field.TypeUUID, Nullable: true},
	}
...
func init() {
	CollarsTable.ForeignKeys[0].RefTable = PetsTable

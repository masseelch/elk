...
// function as Compartment mutator.
type CompartmentFunc func(context.Context, *ent.CompartmentMutation) (ent.Value, error)

// Mutate calls f(ctx, m).
func (f CompartmentFunc) Mutate(ctx context.Context, m ent.Mutation) (ent.Value, error) {
	mv, ok := m.(*ent.CompartmentMutation)
	if !ok {
		return nil, fmt.Errorf("unexpected mutation type %T. expect *ent.CompartmentMutation", m)
	}
	return f(ctx, mv)
}
...
// Mutate calls f(ctx, m).
func (f FridgeFunc) Mutate(ctx context.Context, m ent.Mutation) (ent.Value, error) {

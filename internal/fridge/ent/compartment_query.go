...
func (cq *CompartmentQuery) QueryFridge() *FridgeQuery {
	query := &FridgeQuery{config: cq.config}
...
// Returns a *NotSingularError when exactly one Compartment entity is not found.
...
// Returns a *NotSingularError when exactly one Compartment ID is not found.
...
func (cq *CompartmentQuery) GroupBy(field string, fields ...string) *CompartmentGroupBy {
	group := &CompartmentGroupBy{config: cq.config}
...
func (cq *CompartmentQuery) Select(fields ...string) *CompartmentSelect {
	...
	return &CompartmentSelect{CompartmentQuery: cq}
}
...
func (cq *CompartmentQuery) sqlAll(ctx context.Context) ([]*Compartment, error) {
	var (
		nodes       = []*Compartment{}
		withFKs     = cq.withFKs
		_spec       = cq.querySpec()
	...
	if query := cq.withFridge; query != nil {
		...
		for _, n := range neighbors {
			...
			if !ok {
				return nil, fmt.Errorf(`unexpected foreign-key "fridge_compartments" returned %v`, n.ID)
			}
			for i := range nodes {
				nodes[i].Edges.Fridge = n
			}
		}
	}
	...
	if query := cq.withContents; query != nil {
		...
		for _, n := range neighbors {
			...
			if fk == nil {
				return nil, fmt.Errorf(`foreign-key "compartment_contents" is nil for node %v`, n.ID)
			}
			node, ok := nodeids[*fk]
			if !ok {
				return nil, fmt.Errorf(`unexpected foreign-key "compartment_contents" returned %v for node %v`, *fk, n.ID)
			}
...
func (cq *CompartmentQuery) sqlExist(ctx context.Context) (bool, error) {
...
func (cgb *CompartmentGroupBy) Strings(ctx context.Context) ([]string, error) {
	if len(cgb.fields) > 1 {
		return nil, errors.New("ent: CompartmentGroupBy.Strings is not achievable when grouping more than 1 field")
	}
	var v []string
	if err := cgb.Scan(ctx, &v); err != nil {
		return nil, err
...
func (cgb *CompartmentGroupBy) String(ctx context.Context) (_ string, err error) {
	...
	case 0:
		err = &NotFoundError{compartment.Label}
	default:
		err = fmt.Errorf("ent: CompartmentGroupBy.Strings returned %d results when one was expected", len(v))
	}
	return
}
...
func (cgb *CompartmentGroupBy) Ints(ctx context.Context) ([]int, error) {
	if len(cgb.fields) > 1 {
		return nil, errors.New("ent: CompartmentGroupBy.Ints is not achievable when grouping more than 1 field")
	}
	var v []int
	if err := cgb.Scan(ctx, &v); err != nil {
		return nil, err
...
func (cgb *CompartmentGroupBy) Int(ctx context.Context) (_ int, err error) {
	...
	case 0:
		err = &NotFoundError{compartment.Label}
	default:
		err = fmt.Errorf("ent: CompartmentGroupBy.Ints returned %d results when one was expected", len(v))
	}
	return
}
...
func (cgb *CompartmentGroupBy) Float64s(ctx context.Context) ([]float64, error) {
	if len(cgb.fields) > 1 {
		return nil, errors.New("ent: CompartmentGroupBy.Float64s is not achievable when grouping more than 1 field")
	}
	var v []float64
	if err := cgb.Scan(ctx, &v); err != nil {
		return nil, err
...
func (cgb *CompartmentGroupBy) Float64(ctx context.Context) (_ float64, err error) {
	...
	case 0:
		err = &NotFoundError{compartment.Label}
	default:
		err = fmt.Errorf("ent: CompartmentGroupBy.Float64s returned %d results when one was expected", len(v))
	}
	return
}
...
func (cgb *CompartmentGroupBy) Bools(ctx context.Context) ([]bool, error) {
	if len(cgb.fields) > 1 {
		return nil, errors.New("ent: CompartmentGroupBy.Bools is not achievable when grouping more than 1 field")
	}
	var v []bool
	if err := cgb.Scan(ctx, &v); err != nil {
		return nil, err
...
func (cgb *CompartmentGroupBy) Bool(ctx context.Context) (_ bool, err error) {
	...
	case 0:
		err = &NotFoundError{compartment.Label}
	default:
		err = fmt.Errorf("ent: CompartmentGroupBy.Bools returned %d results when one was expected", len(v))
	}
	return
}
...
func (cgb *CompartmentGroupBy) sqlScan(ctx context.Context, v interface{}) error {
...
func (cgb *CompartmentGroupBy) sqlQuery() *sql.Selector {
...
func (cs *CompartmentSelect) Scan(ctx context.Context, v interface{}) error {
	...
	cs.sql = cs.CompartmentQuery.sqlQuery(ctx)
...
func (cs *CompartmentSelect) Strings(ctx context.Context) ([]string, error) {
	if len(cs.fields) > 1 {
		return nil, errors.New("ent: CompartmentSelect.Strings is not achievable when selecting more than 1 field")
	}
	var v []string
	if err := cs.Scan(ctx, &v); err != nil {
		return nil, err
...
func (cs *CompartmentSelect) String(ctx context.Context) (_ string, err error) {
	...
	case 0:
		err = &NotFoundError{compartment.Label}
	default:
		err = fmt.Errorf("ent: CompartmentSelect.Strings returned %d results when one was expected", len(v))
	}
	return
}
...
func (cs *CompartmentSelect) Ints(ctx context.Context) ([]int, error) {
	if len(cs.fields) > 1 {
		return nil, errors.New("ent: CompartmentSelect.Ints is not achievable when selecting more than 1 field")
	}
	var v []int
	if err := cs.Scan(ctx, &v); err != nil {
		return nil, err
...
func (cs *CompartmentSelect) Int(ctx context.Context) (_ int, err error) {
	...
	case 0:
		err = &NotFoundError{compartment.Label}
	default:
		err = fmt.Errorf("ent: CompartmentSelect.Ints returned %d results when one was expected", len(v))
	}
	return
}
...
func (cs *CompartmentSelect) Float64s(ctx context.Context) ([]float64, error) {
	if len(cs.fields) > 1 {
		return nil, errors.New("ent: CompartmentSelect.Float64s is not achievable when selecting more than 1 field")
	}
	var v []float64
	if err := cs.Scan(ctx, &v); err != nil {
		return nil, err
...
func (cs *CompartmentSelect) Float64(ctx context.Context) (_ float64, err error) {
	...
	case 0:
		err = &NotFoundError{compartment.Label}
	default:
		err = fmt.Errorf("ent: CompartmentSelect.Float64s returned %d results when one was expected", len(v))
	}
	return
}
...
func (cs *CompartmentSelect) Bools(ctx context.Context) ([]bool, error) {
	if len(cs.fields) > 1 {
		return nil, errors.New("ent: CompartmentSelect.Bools is not achievable when selecting more than 1 field")
	}
	var v []bool
	if err := cs.Scan(ctx, &v); err != nil {
		return nil, err
...
func (cs *CompartmentSelect) Bool(ctx context.Context) (_ bool, err error) {
	...
	case 0:
		err = &NotFoundError{compartment.Label}
	default:
		err = fmt.Errorf("ent: CompartmentSelect.Bools returned %d results when one was expected", len(v))
	}
	return
}
...
func (cs *CompartmentSelect) sqlScan(ctx context.Context, v interface{}) error {
	rows := &sql.Rows{}

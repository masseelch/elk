...
func flutterClientTpl() (*asset, error) {
	...
	info := bindataFileInfo{name: "flutter/client.tpl", size: 8018, mode: os.FileMode(420), modTime: time.Unix(1617868922, 0)}
